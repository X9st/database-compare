#!/usr/bin/env python3
"""DM connector smoke test for database-compare backend."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Smoke test DM connector.")
    parser.add_argument("--host", required=True, help="DM host")
    parser.add_argument("--port", type=int, default=5236, help="DM port")
    parser.add_argument("--database", default="DMTEST", help="DM database/service name")
    parser.add_argument("--schema", default="QA_COMPARE", help="Schema")
...
def main() -> int:
    ...
    print("[INFO] testing DM connection...")
    ...
    print("[PASS] DM connector smoke test passed.")
    return 0
